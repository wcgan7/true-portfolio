...
import type { ExposureEngine } from "@/src/lib/engines/interfaces";
import type {
...
import type { OverviewHolding, OverviewWarning } from "@/src/lib/services/valuation-core";
...
export const tsExposureEngine: ExposureEngine = {
  applyLookThrough,
